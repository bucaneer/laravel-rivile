...
class InvoiceDebt extends RivileObject {
	...
	protected static $edit_method = false;

	/**
	 * GET_I06_DEBT returns fewer fields than GET_I06_LIST,
	 * but should use the full set of defs because other fields
	 * (e.g. i06_r_date) are still usable in where_condition.
	 */
	protected static $defs = [
		...
		'i06_suma_db' => ['numeric', 'max:9999999999999999.99'],
		'i06_suma_cr' => ['numeric', 'max:9999999999999999.99'],
		'i06_suma_db_vl' => ['numeric', 'max:9999999999999999.99'],
		'i06_suma_cr_vl' => ['numeric', 'max:9999999999999999.99'],
	];
